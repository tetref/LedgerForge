...
#[derive(Debug)]
pub struct LedgerForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LedgerForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LedgerForge processing");
    
    let mut processor = LedgerForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LedgerForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LedgerForgeProcessor::new(false);
